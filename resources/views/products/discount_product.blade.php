...
<div class="container-fluid" style="background-color:#F3F3F3;">
    ...
    <div class="container" style="background-color:#FFFFFF">
        <h2 class="justify-content-center">Discount Products</h2>
    ...
    @foreach ($discount_product as $product)
            ...
            <div class="col-md-4" style="text-align: center;">
                <a href="{{ url('') }}/product/{{$product->id}}">
                    ...
                    <p>{{$product->title}}<br><del style="color:red; font-size: 14px;">Tk:{{($product->discount_price + $product->price)}}</del><br>TK:{{$product->price}}</p>
                </a>
            </div>
            @endforeach
        @endif
